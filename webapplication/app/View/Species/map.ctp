...
//    $map_tool_url = $this->Html->url(array("controller" => "tools", "action" => "map"));
    ...
    if ($single_species_map) {
        ...
        echo $this->Html->scriptBlock($code_block, array('inline'=>false));
        echo $this->Html->script(array('species_map'), array('inline'=>false));
    } else {
        ...
        $code_block =  "var species_id = undefined;".
                       ...
                       "var species_route_url= '".$species_route_url."';";
        echo $this->Html->scriptBlock($code_block, array('inline'=>false));
        echo $this->Html->script('species_map', array('inline'=>false));
