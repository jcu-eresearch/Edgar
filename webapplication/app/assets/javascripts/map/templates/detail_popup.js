...
Edgar.templates.mapPopup = function(opt_data, opt_sb) {
  ...
  output.append('<div class="map-popup-wrapper ui-corner-all"><div class="map-popup-tabs"><div class="close-button"></div><ul class="tab-strip"><li><a>summary</a></li><li><a>detail</a></li></ul><div class="tab-panel summary-panel"><dl>', (opt_data.gridBounds) ? '<dt>Latitude Range</dt><dd>' + soy.$$escapeHtml(opt_data.gridBounds.minlat) + '&deg; to ' + soy.$$escapeHtml(opt_data.gridBounds.maxlat) + '&deg;</dd><dt>Longitude Range</dt><dd>' + soy.$$escapeHtml(opt_data.gridBounds.minlon) + '&deg; to ' + soy.$$escapeHtml(opt_data.gridBounds.maxlon) + '&deg;</dd>' : (opt_data.occurrenceCoord) ? '<dt>Latitude</dt><dd>' + soy.$$escapeHtml(opt_data.occurrenceCoord.lat) + '</dd><dt>Longitude</dt><dd>' + soy.$$escapeHtml(opt_data.occurrenceCoord.lon) + '</dd>' : '', '</dl>');
  ...
  output.append('</div><div class="tab-panel details-panel"></div></div></div>');
...
Edgar.templates.mapPopupDetailsPanel = function(opt_data, opt_sb) {
  ...
  if (fListLen65 > 0) {
    for (var fIndex65 = 0; fIndex65 < fListLen65; fIndex65++) {
      ...
      output.append('<div class="occurrence-detail">(', soy.$$escapeHtml(fData65.geometry.coordinates[0]), ', ', soy.$$escapeHtml(fData65.geometry.coordinates[1]), ') with', soy.$$escapeHtml(fData65.properties.uncertainty ? ' ' : ''), soy.$$escapeHtml(fData65.properties.uncertainty ? fData65.properties.uncertainty : ' unknown '), soy.$$escapeHtml(fData65.properties.uncertainty ? 'm ' : ''), 'accuracy<br />Basis: ', soy.$$escapeHtml(fData65.properties.basis ? fData65.properties.basis : 'unknown'), '<br />Date: ', soy.$$escapeHtml(fData65.properties.date ? fData65.properties.date : 'unknown'), '<br />Source: <a href="', soy.$$escapeHtml(fData65.properties.source_url), '">', soy.$$escapeHtml(fData65.properties.source_name), '</a></div>');
    }
  } else {
